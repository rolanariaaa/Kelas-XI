...
Laravel API untuk sistem monitoring kelas sekolah yang dapat terhubung dengan aplikasi Android.

## Database Setup

- Database: `sekolah`
- Tabel utama: `users` (nama, email, password, role)
...
### Format Request untuk POST/PUT User:
```json
{
    "nama": "Nama Lengkap",
